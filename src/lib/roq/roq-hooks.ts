...
export function useFoodItemFindMany<
...
>(
  ...
  const key = JSON.stringify(['useFoodItemFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.food_item.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useFoodItemCount<T extends Prisma.food_itemCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.food_itemCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useFoodItemCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.food_item.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useFoodItemFindManyWithCount<
  T extends Prisma.food_itemFindManyArgs,
  R extends { data: GetFindResult<Prisma.$food_itemPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.food_itemFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useFoodItemFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.food_item.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useFoodItemFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useFoodItemFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.food_item.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
