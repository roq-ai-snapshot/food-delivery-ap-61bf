...
import type { Prisma, food_item, menu, order, order_item, restaurant, user } from './types';
import { DefaultArgs, GetFindResult } from './types/runtime/library';

export type RequestOptions = Record<string, any>;

interface Food_itemSDK {
  create: <T extends Prisma.food_itemCreateArgs, R extends CheckSelect<T, food_item, Prisma.food_itemGetPayload<T>>>(
    data: Prisma.SelectSubset<T, Prisma.food_itemCreateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  createMany: <T extends Prisma.food_itemCreateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.food_itemCreateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  update: <T extends Prisma.food_itemUpdateArgs, R extends Prisma.food_itemGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.food_itemUpdateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  updateMany: <T extends Prisma.food_itemUpdateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.food_itemUpdateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  upsert: <T extends Prisma.food_itemUpsertArgs, R extends Prisma.food_itemGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.food_itemUpsertArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  delete: <T extends Prisma.food_itemDeleteArgs, R extends Prisma.food_itemGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.food_itemDeleteArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  deleteMany: <T extends Prisma.food_itemDeleteManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.food_itemDeleteManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  findMany: <
    T extends Prisma.food_itemFindManyArgs,
    R extends GetFindResult<Prisma.$food_itemPayload<DefaultArgs>, T>[],
  >(
    args: Prisma.SelectSubset<T, Prisma.food_itemFindManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  count: <T extends Prisma.food_itemCountArgs, R extends number>(
    args: Prisma.SelectSubset<T, Prisma.food_itemCountArgs>,
    options?: RequestOptions,
  ) => Promise<R>;
  ...
  findFirst: <
    T extends Prisma.food_itemFindFirstArgs,
    R extends GetFindResult<Prisma.$food_itemPayload<DefaultArgs>, T>,
  >(
    args?: Prisma.SelectSubset<T, Prisma.food_itemFindFirstArgs>,
    options?: RequestOptions,
  ) => Promise<R>;
}
...
export class RoqBaasSdk {
  ...
  private initSDK() {
    ...
    this.food_item = {
      create: async function createFood_item<
        T extends Prisma.food_itemCreateArgs,
        R extends CheckSelect<T, food_item, Prisma.food_itemGetPayload<T>>,
      >(data: Prisma.SelectSubset<T, Prisma.food_itemCreateArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/food_item/create`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      createMany: async function createManyFood_item<
        T extends Prisma.food_itemCreateManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.food_itemCreateManyArgs>, options?: RequestOptions) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/food_item/createMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      update: async function updateFood_item<
        T extends Prisma.food_itemUpdateArgs,
        R extends Prisma.food_itemGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.food_itemUpdateArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/food_item/update`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      updateMany: async function updateManyFood_item<
        T extends Prisma.food_itemUpdateManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.food_itemUpdateManyArgs>, options?: RequestOptions) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/food_item/updateMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      upsert: async function upsertFood_item<
        T extends Prisma.food_itemUpsertArgs,
        R extends Prisma.food_itemGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.food_itemUpsertArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/food_item/upsert`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      delete: async function deleteFood_item<
        T extends Prisma.food_itemDeleteArgs,
        R extends Prisma.food_itemGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.food_itemDeleteArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/food_item/delete`;
      ...
      deleteMany: async function deleteManyFood_item<
        T extends Prisma.food_itemDeleteManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.food_itemDeleteManyArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/food_item/deleteMany`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, false>(
          reqUrl,
          {
      ...
      findMany: async function findManyFood_item<
        T extends Prisma.food_itemFindManyArgs,
        R extends GetFindResult<Prisma.$food_itemPayload<DefaultArgs>, T>[],
      >(args: Prisma.SelectSubset<T, Prisma.food_itemFindManyArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/food_item/findMany`;
      ...
      count: async function countFood_item<T extends Prisma.food_itemCountArgs, R extends number>(
        args: Prisma.SelectSubset<T, Prisma.food_itemCountArgs>,
        options?: RequestOptions,
      ) {
        const url = `${ctx.endpoint}/api/model/food_item/count`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      findManyWithCount: async function findManyWithCountFood_item<
        T extends Prisma.food_itemFindManyArgs,
        R extends GetFindResult<Prisma.$food_itemPayload<DefaultArgs>, T>[],
        C extends number,
      >(args: Prisma.SelectSubset<T, Prisma.food_itemFindManyArgs>, options?: RequestOptions) {
        ...
        const [data, count] = await Promise.all([
          ctx.food_item.findMany(args, options),
          ctx.food_item.count(
            {
              orderBy,
              where,
      ...
      findFirst: async function findFirstFood_item<
        T extends Prisma.food_itemFindFirstArgs,
        R extends GetFindResult<Prisma.$food_itemPayload<DefaultArgs>, T>,
      >(args?: Prisma.SelectSubset<T, Prisma.food_itemFindFirstArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/food_item/findFirst`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
