...
import { useFoodItemFindFirst, useRoqClient } from 'lib/roq';
...
function FoodItemViewPage() {
  ...
  const queryParams = useMemo<{ include: { menu: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useFoodItemFindFirst(queryParams, {}, { disabled: !id });
