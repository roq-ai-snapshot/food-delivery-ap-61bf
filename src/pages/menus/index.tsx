  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['restaurant', 'food_item.count'],
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'description', header: 'Description', accessorKey: 'description' },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.availability_start ? format(record?.availability_start, 'dd-MM-yyyy') : '',
    },
    {
      id: 'availability_end',
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.availability_end ? format(record?.availability_end, 'dd-MM-yyyy') : '',
    },
